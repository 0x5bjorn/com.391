...
int main(int argc, char **argv)
{
    ...
    // ! ! ! HAND ! ! !
    auto hand_geometry_data = geometry_generators::generate_plane_geometry_data(1.0f, 1.0f, 1, 1);
    auto hand_geometry = std::make_shared<ES2Geometry>(hand_geometry_data.first, hand_geometry_data.second);
    hand_geometry->set_type(Geometry::Type::TriangleFan);
    ...
    plane_geometry->set_type(Geometry::Type::TriangleFan);
    ...
    for (;;) {
        ...
        // TODO
        center->set_rotation_y(center->get_rotation_y() - 0.01f);
