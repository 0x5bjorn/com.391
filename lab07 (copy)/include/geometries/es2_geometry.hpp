    ...
    public:
        ...
        void update(const Material &material) final
        {
            ...
            if (_requires_indices_update || _requires_vertices_update) {
                ...
                GLsizei stride = sizeof(GLfloat) * 22;
                ...
                int tangentDet_attribute_location{attributes.count("tangentDet") > 0 ? attributes.at("tangentDet") : -1};
                if (tangentDet_attribute_location != -1) {
                    glEnableVertexAttribArray(tangentDet_attribute_location);
                    glVertexAttribPointer(
                        tangentDet_attribute_location,
                ...
                if (texture2_coordinates_attribute_location != -1) {
                    ...
                    glVertexAttribPointer(
                        ...
                        4, GL_FLOAT, GL_FALSE, stride, reinterpret_cast<const GLvoid *>(sizeof(GLfloat) * 18)
                    );
                }
#ifdef __APPLE__
