...
namespace aur
{
    ...
    public:
        ...
        [[nodiscard]] const std::shared_ptr<Texture> &get_texture_1_normal() const
        {
            return _texture1_normal;
        }

        void set_texture_1_normal(const std::shared_ptr<Texture> &texture_1_normal)
        {
            _texture1_normal = texture_1_normal;
        }
    ...
    protected:
        ...
        std::shared_ptr<Texture> _texture1_normal;
