...
namespace aur
{
    ...
    public:
        ...
        [[nodiscard]] const std::function<void(int, const Uint8*)> &get_on_key_down() const
        {
            return _on_key_down;
        }

        void set_on_key_down(const std::function<void(int, const Uint8*)> &on_key_down)
        {
        ...
        [[nodiscard]] const std::function<void(int, int, int, int)> &get_on_mouse_down() const
        {
            return _on_mouse_down;
        }

        void set_on_mouse_down(const std::function<void(int, int, int, int)> &on_mouse_down)
        {
    ...
    protected:
        ...
        std::function<void(int, const Uint8*)> _on_key_down;
        std::function<void(int, int, int, int)> _on_mouse_move;
        std::function<void(int, int, int, int)> _on_mouse_down;
    };
}
